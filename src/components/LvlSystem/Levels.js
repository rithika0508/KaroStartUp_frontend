          ...
          <div className={styles.levels__main}>
            ...
            <div className={styles.footer}>
              ...
              <div className={styles.connect}>
                ...
                <a href="https://www.instagram.com/karo_startup/" className={styles.link}>
              ...
              <div className={styles.connect}>
                ...
                <a href="https://in.linkedin.com/company/karo-startup/" className={styles.link}>
              ...
              <div className={styles.connect}>
                ...
                <a href="https://www.facebook.com/karostartup/" className={styles.link}>
